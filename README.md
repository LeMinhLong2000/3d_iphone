...
This is a clone of Apple's iPhone 15 Pro website using React.js (version 18) and TailwindCSS. It highlights the effective use of GSAP (Greensock Animations) and Three.js for displaying iPhone 15 Pro models in various colors and shapes.
...
```bash
npm create vite@latest my-project -- --template react@18
cd my-project
npm install
```
